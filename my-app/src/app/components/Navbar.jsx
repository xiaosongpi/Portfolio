        ...
        <nav className="max-w-7xl mx-auto px-12 pt-5 w-auto sticky top-0">
            <div className="relative flex">
                ...
                <div className="absolute right-0 grid grid-rows-[repeat(2, auto)] border rounded-full">
                    <button className="w-12 h-12 bg-linear-to-tl from-[#00000080] via-[#56565640] to-[#d0d0d080] flex items-center justify-center border rounded-full cursor-pointer hover:shadow-[0_0_15px_#ffffff] transition duration-500">
                        <Image 
