        ...
        <div className="w-full max-w-[1440] h-screen mx-auto px-12 flex items-center justify-center">
            <div className="w-[90%] grid grid-cols-[auto_1fr] items-center justify-center gap-3">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-1xl">Highly motivated to keep learning, face new challenges, and committed to giving my best effort by applying my knowledge and skills to achieve optimal results.</p>
                </div>
            </div>
        </div>      
    );
